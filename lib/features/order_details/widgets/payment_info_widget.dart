...
class PaymentInfoWidget extends StatelessWidget {
  ...
  const PaymentInfoWidget({super.key, this.itemsPrice, this.discount, this.tax, this.subTotal, this.deliveryCharge, this.totalPrice, this.isPaid = false, this.referAndEarnDiscount});
